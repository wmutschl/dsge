function [residual, g1, g2, g3] = a_ar_dynamic(y, x, params, steady_state, it_)
%
...
residual(3)= lhs-rhs;
lhs =y(13);
rhs =params(7)*y(5)+params(9)*x(it_, 1);
residual(4)= lhs-rhs;
lhs =y(13);
rhs =y(10)-y(3);
residual(5)= lhs-rhs;
...
residual(6)= lhs-rhs;
lhs =y(9);
rhs =params(7)*(y(10)-y(3))+y(11)*(1-params(8))/(1+params(1));
residual(7)= lhs-rhs;
lhs =y(12);
rhs =y(10)-y(3)+y(7)-y(1)-(y(11)-y(4))/(1+params(1));
residual(8)= lhs-rhs;
if nargout >= 2,
  g1 = zeros(8, 16);
