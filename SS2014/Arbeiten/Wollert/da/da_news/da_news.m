...
M_.endo_names = char(M_.endo_names, 'news');
M_.endo_names_tex = char(M_.endo_names_tex, 'news');
M_.endo_names_long = char(M_.endo_names_long, 'news');
M_.param_names = 'phi';
...
options_.bytecode=0;
options_.use_dll=0;
erase_compiled_function('da_news_static');
erase_compiled_function('da_news_dynamic');
...
save('da_news_results.mat', 'oo_', 'M_', 'options_');
if exist('estim_params_', 'var') == 1
  save('da_news_results.mat', 'estim_params_', '-append');
end
if exist('bayestopt_', 'var') == 1
  save('da_news_results.mat', 'bayestopt_', '-append');
end
if exist('dataset_', 'var') == 1
  save('da_news_results.mat', 'dataset_', '-append');
end
if exist('estimation_info', 'var') == 1
  save('da_news_results.mat', 'estimation_info', '-append');
end
