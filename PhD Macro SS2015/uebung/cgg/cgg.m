...
estim_params_.param_vals = [estim_params_.param_vals; 7, NaN, (-Inf), Inf, 1, 0.9, .04, NaN, NaN, NaN ];
estim_params_.param_vals = [estim_params_.param_vals; 8, NaN, (-Inf), Inf, 3, 0.5, .04, NaN, NaN, NaN ];
options_.first_obs = 51;
options_.mh_jscale = 2.5;
options_.mh_nblck = 2;
options_.mh_replic = 15000;
