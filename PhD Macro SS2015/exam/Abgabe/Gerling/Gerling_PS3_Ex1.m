...
options_ = [];
M_.fname = 'Gerling_PS3_Ex1';
%
% Some global variables initialization
%
global_initialization;
diary off;
diary('Gerling_PS3_Ex1.log');
M_.exo_names = 'ez';
M_.exo_names_tex = 'ez';
...
options_.bytecode=0;
options_.use_dll=0;
erase_compiled_function('Gerling_PS3_Ex1_static');
erase_compiled_function('Gerling_PS3_Ex1_dynamic');
...
var_list_ = 'z';
rplot(var_list_);
save('Gerling_PS3_Ex1_results.mat', 'oo_', 'M_', 'options_');
if exist('estim_params_', 'var') == 1
  save('Gerling_PS3_Ex1_results.mat', 'estim_params_', '-append');
end
if exist('bayestopt_', 'var') == 1
  save('Gerling_PS3_Ex1_results.mat', 'bayestopt_', '-append');
end
if exist('dataset_', 'var') == 1
  save('Gerling_PS3_Ex1_results.mat', 'dataset_', '-append');
end
if exist('estimation_info', 'var') == 1
  save('Gerling_PS3_Ex1_results.mat', 'estimation_info', '-append');
end
