...
////    Edited by Lasse Laumann on September 01, 2015    ////                                   
/////////////////////////////////////////////////////////////
set_dynare_seed(123);
...
rhoR,   delta_pdf,       0.50,   0.20;	
rhog,   delta_pdf,       0.80,   0.10; 
...
stoch_simul(order=1,nocorr,nomoments,irf=0,periods=10000); % Simulate in order to get a dataset with 10000 observations

save('simdat','YGR','INFL','INT'); % Save obtained data new file
...
estimation(order=1,datafile=simdat,first_obs=401,nobs=200,mh_replic=2500,mh_nblocks=3,mh_jscale=0.65); % Conduct Bayesian estimation 
