/////////////////////////////////////////////////////////////
////    Macroeconomics PhD Problem Set 2, Excercise 2    ////
...
/////////////////////////////////////////////////////////////
% I took the mod file AnScho from the lecture and  
% added varobs and two scenarios for excercise 2.2 and 2.4

% scenario = 1: Stochastic model - Simulate data (2.2)
% scenario = 2: Bayesian Estimation small sample size (2.4)
@#define scenario = 1
...
varexo e_z e_g e_R;
varobs YGR INFL INT; % observable variables in the model. 
