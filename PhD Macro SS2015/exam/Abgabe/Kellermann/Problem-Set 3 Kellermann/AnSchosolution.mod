...
////    Version: September 03, 2015    			   		 ////
/////////////////////////////////////////////////////////////
set_dynare_seed(123);
var y c p R g z YGR INFL INT; %endogenous variables
varexo e_z e_g e_R; % exogenous variables
varobs YGR INFL INT; %observables: number of observables = number of shocks (or greater)
parameters tau kap psi1 psi2 rhoR rhog rhoz r_A p_A gam_Q stdR stdg stdz; % parameters
...
save('simdat'); %save as is required
