...
options_ = [];
M_.fname = 'BaxterandKing_Helfer';
%
% Some global variables initialization
%
global_initialization;
diary off;
diary('BaxterandKing_Helfer.log');
M_.exo_names = 'ez';
M_.exo_names_tex = 'ez';
...
options_.bytecode=0;
options_.use_dll=0;
erase_compiled_function('BaxterandKing_Helfer_static');
erase_compiled_function('BaxterandKing_Helfer_dynamic');
...
var_list_ = 'z';
rplot(var_list_);
save('BaxterandKing_Helfer_results.mat', 'oo_', 'M_', 'options_');
if exist('estim_params_', 'var') == 1
  save('BaxterandKing_Helfer_results.mat', 'estim_params_', '-append');
end
if exist('bayestopt_', 'var') == 1
  save('BaxterandKing_Helfer_results.mat', 'bayestopt_', '-append');
end
if exist('dataset_', 'var') == 1
  save('BaxterandKing_Helfer_results.mat', 'dataset_', '-append');
end
if exist('estimation_info', 'var') == 1
  save('BaxterandKing_Helfer_results.mat', 'estimation_info', '-append');
end
