...
% Simulation of data (10000 observations) for the variables YGR, INFL and 
% INT.

    stoch_simul(periods=10000, irf=0, order=1, nocorr, nomoments); 
    save('simdat.mat', 'YGR', 'INFL', 'INT');

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% task 4 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

% Estimation of the Posterior-distribution (in comparison with the prior
% distribution, in which only the observations 401-600 of the simulated  
% data are used).
