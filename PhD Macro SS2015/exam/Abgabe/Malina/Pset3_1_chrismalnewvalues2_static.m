function [residual, g1, g2] = Pset3_1_chrismalnewvalues2_static(y, x, params)
%
...
T59 = y(5)^(1-params(4));
T204 = (-(100*(1/y(1)-1/(y(1)))));
T226 = ((y(12))-y(12))/((y(12))*(y(12)))/(y(12)/(y(12)));
T238 = ((y(13))-y(13))/((y(13))*(y(13)))/(y(13)/(y(13)));
lhs =(1-y(13))*y(9);
rhs =params(6)*y(2)/(1-y(5));
residual(1)= lhs-rhs;
lhs =T19;
rhs =params(1)*T19*(1-params(2)+(1-y(13))*y(10));
residual(2)= lhs-rhs;
lhs =y(1);
rhs =y(2)+y(7)+y(8)+y(6);
residual(3)= lhs-rhs;
...
residual(8)= lhs-rhs;
lhs =y(8)+y(6)+y(11);
rhs =y(13)*(y(9)*y(5)+y(10)*y(3));
residual(9)= lhs-rhs;
lhs =y(8)-(y(8));
rhs =(y(8)-(y(8)))*params(5)+x(2);
residual(10)= lhs-rhs;
lhs =y(6)-(y(6));
rhs =params(5)*(y(6)-(y(6)))+x(3);
residual(11)= lhs-rhs;
lhs =log(y(13)/(y(13)));
rhs =params(5)*log(y(13)/(y(13)))+x(4);
residual(12)= lhs-rhs;
lhs =log(y(12)/(y(12)));
rhs =params(5)*log(y(12)/(y(12)))+x(1);
residual(13)= lhs-rhs;
lhs =y(14);
rhs =100*(y(1)-(y(1)))/(y(1));
residual(14)= lhs-rhs;
...
if nargout >= 2,
  ...
  g1(1,9)=1-y(13);
  g1(1,13)=(-y(9));
  g1(2,2)=(-1)/(y(2)*y(2))-params(1)*(1-params(2)+(1-y(13))*y(10))*(-1)/(y(2)*y(2));
  g1(2,10)=(-(params(1)*(1-y(13))*T19));
  g1(2,13)=(-(params(1)*T19*(-y(10))));
  g1(3,1)=1;
  g1(3,2)=(-1);
  g1(3,6)=(-1);
  g1(3,7)=(-1);
  ...
  g1(9,10)=(-(y(13)*y(3)));
  g1(9,11)=1;
  g1(9,13)=(-(y(9)*y(5)+y(10)*y(3)));
  g1(12,13)=T238-params(5)*T238;
  g1(13,12)=T226-params(5)*T226;
