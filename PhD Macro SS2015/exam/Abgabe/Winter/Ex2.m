...
options_.bytecode=0;
options_.use_dll=0;
erase_compiled_function('Ex2_static');
erase_compiled_function('Ex2_dynamic');
...
options_.mh_nblck = 3;
options_.mh_replic = 2500;
options_.order = 1;
options_.datafile = 'simdat';
options_.nobs = 200;
var_list_=[];
dynare_estimation(var_list_);
save('Ex2_results.mat', 'oo_', 'M_', 'options_');
if exist('estim_params_', 'var') == 1
  save('Ex2_results.mat', 'estim_params_', '-append');
end
if exist('bayestopt_', 'var') == 1
  save('Ex2_results.mat', 'bayestopt_', '-append');
end
if exist('dataset_', 'var') == 1
  save('Ex2_results.mat', 'dataset_', '-append');
end
if exist('estimation_info', 'var') == 1
  save('Ex2_results.mat', 'estimation_info', '-append');
end
