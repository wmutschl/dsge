...
% y p c does not work
% YGR p c does not work
% INFL p c does not work
...
% INT P C works
    ...
    save('simdat','INT','INFL','YGR'); 
    
estimation(order=1,datafile=simdat,first_obs=401,nobs=200,mh_replic=500,mh_nblocks=3,mh_jscale=0.65);
