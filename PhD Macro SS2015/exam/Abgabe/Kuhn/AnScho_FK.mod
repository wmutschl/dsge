...
kap,    normal_pdf,     0.20,   0.05; %old: beta var=0.1
psi1,   gamma_pdf,      1.50,   0.25;		
psi2,   normal_pdf,     0.60,   0.25; %old: gamma 0.5 
rhoR,   beta_pdf,       0.50,   0.20;		
rhog,   beta_pdf,       0.80,   0.10;
rhoz,   beta_pdf,       0.66,   0.15;
p_A,    normal_pdf,     4.00,   0.50;
r_A,    gamma_pdf,      3.50,   0.50; %old: normal 4.00
...
%-------------------------------------------------
% Scenario 1: Simulate data 
%-------------------------------------------------
@# if scenario == 1
    steady;
    check;
    resid;
    stoch_simul(order=1,nocorr,nomoments,irf=100,periods=10000);
