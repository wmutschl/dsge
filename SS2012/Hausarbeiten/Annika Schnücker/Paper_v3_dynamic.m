function [residual, g1, g2, g3] = Paper_v3_dynamic(y, x, params, steady_state, it_)
%
...
residual(1)= lhs-rhs;
lhs =y(18);
rhs =T34*y(4)+T37*y(33)+params(4)/(1+params(3))*y(17)-y(25)/(1+params(3));
residual(2)= lhs-rhs;
lhs =y(17);
...
residual(5)= lhs-rhs;
lhs =y(15);
rhs =T37*y(31)+T34*y(2)+y(30)*T37-y(14)*(1+params(3)*params(9))/(1+params(3))+y(1)*params(9)/(1+params(3))-T133*(y(15)-params(11)*y(22)-params(2)/(1-params(1))*(y(19)-params(1)*y(5))+y(27)-x(it_, 10));
residual(6)= lhs-rhs;
lhs =y(22);
...
residual(9)= lhs-rhs;
lhs =y(20);
rhs =params(17)*y(6)+(1-params(17))*(y(29)+params(18)*(y(1)-y(29))+y(23)*params(19))+params(20)*(y(14)-y(1))+params(21)*(y(23)-y(7))-params(22)*x(it_, 1)-params(23)*x(it_, 4)+x(it_, 9);
residual(10)= lhs-rhs;
lhs =y(25);
...
residual(12)= lhs-rhs;
lhs =y(27);
rhs =x(it_, 4)+params(28)*y(11);
residual(13)= lhs-rhs;
lhs =y(28);
rhs =params(29)*y(12)+x(it_, 5);
residual(14)= lhs-rhs;
lhs =y(24);
rhs =x(it_, 1)+params(25)*y(8);
residual(15)= lhs-rhs;
lhs =y(29);
