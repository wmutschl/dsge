...
%%%%	Bayesian Estimation								  %%%%
%%%%    Exercise 5g with Cobb-Douglas-Production-Function %%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
%----------------------------------------------------------------
	...
	estimation(datafile=artificial_sample,first_obs=8001,nobs=200,mh_replic=5000,mh_nblocks=3,mode_compute=0,mode_file=Exercise_5g_mode,mh_jscale=1.6);
	estimation(datafile=artificial_sample,first_obs=8001,nobs=200,mh_replic=1000,mh_nblocks=3,mode_compute=0,mode_file=Exercise_5g_mode,load_mh_file,mh_jscale=1.6);
	steady; check;