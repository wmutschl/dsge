...
options_ = [];
M_.fname = 'Exercise_5a';
%
% Some global variables initialization
%
global_initialization;
diary off;
logname_ = 'Exercise_5a.log';
...
options_.bytecode=0;
options_.use_dll=0;
erase_compiled_function('Exercise_5a_static');
erase_compiled_function('Exercise_5a_dynamic');
...
save('Exercise_5a_results.mat', 'oo_', 'M_', 'options_');
