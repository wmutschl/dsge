...
options_ = [];
M_.fname = 'Exercise_5bcdef';
%
% Some global variables initialization
%
global_initialization;
diary off;
logname_ = 'Exercise_5bcdef.log';
...
options_.bytecode=0;
options_.use_dll=0;
erase_compiled_function('Exercise_5bcdef_static');
erase_compiled_function('Exercise_5bcdef_dynamic');
...
options_.datafile = 'artificial_sample';
options_.mode_file = 'Exercise_5bcdef_mode';
options_.nobs = 200;
options_.order = 1;
var_list_=[];
dynare_estimation(var_list_);
...
steady;
check(M_,options_,oo_);
save('Exercise_5bcdef_results.mat', 'oo_', 'M_', 'options_');
