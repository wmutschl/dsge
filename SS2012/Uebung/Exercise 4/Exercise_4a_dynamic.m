function [residual, g1, g2, g3] = Exercise_4a_dynamic(y, x, params, steady_state, it_)
%
...
residual(1)= lhs-rhs;
lhs =y(7);
rhs =y(15)*params(14)+params(2)*(y(5)-y(9));
residual(2)= lhs-rhs;
lhs =y(6);
rhs =y(5)-y(9);
residual(3)= lhs-rhs;
...
residual(7)= lhs-rhs;
lhs =y(12);
rhs =params(9)+y(7)*400;
residual(8)= lhs-rhs;
lhs =y(13);
rhs =params(9)+params(8)+params(10)*4+y(8)*400;
residual(9)= lhs-rhs;
if nargout >= 2,
  g1 = zeros(9, 20);
