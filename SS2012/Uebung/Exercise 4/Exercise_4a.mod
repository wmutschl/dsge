...
%%%%    Not identified coefficients + absurd parameters %%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
@#define Setting = 1 
    ...
    % 0: Estimate all parameters except psi1 and r_A
...
% 2. Set parameters
%----------------------------------------------------------------
% True parameter-values, simdat1.mat is simulated with these values
	tau=2.000; 
	kap=0.150; 
	psi1 =1.500;
	psi2=1.000; 
...
%----------------------------------------------------------------
    ...
    steady; check;
    estimation(order=1,datafile=simdat1,nobs=1000,first_obs=1);
