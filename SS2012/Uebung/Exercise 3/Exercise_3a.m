...
options_ = [];
M_.fname = 'Exercise_3a';
%
% Some global variables initialization
%
global_initialization;
diary off;
logname_ = 'Exercise_3a.log';
...
options_.bytecode=0;
options_.use_dll=0;
erase_compiled_function('Exercise_3a_static');
erase_compiled_function('Exercise_3a_dynamic');
...
save('Exercise_3a_results.mat', 'oo_', 'M_', 'options_');
