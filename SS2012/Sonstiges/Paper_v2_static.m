function [residual, g1, g2] = Paper_v2_static(y, x, params)
%
...
residual(9)= lhs-rhs;
lhs =y(7);
rhs =y(7)*params(17)+(1-params(17))*(y(16)+params(18)*(y(1)-y(16))+y(10)*params(19))+x(9);
residual(10)= lhs-rhs;
lhs =y(12);
...
residual(12)= lhs-rhs;
lhs =y(14);
rhs =y(14)*params(28)+x(4);
residual(13)= lhs-rhs;
lhs =y(15);
rhs =y(15)*params(29)+x(5);
residual(14)= lhs-rhs;
lhs =y(11);
rhs =y(11)*params(25)+x(1);
residual(15)= lhs-rhs;
lhs =y(16);
