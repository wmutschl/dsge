close all;
% Dynamic response to a news shock
a             = cumsum(a_eps_a2);
nat_y         = a;
act_y         = a + x_eps_a2;
nat_nom_rate  = rstar_eps_a2;
act_nom_rate  = r_eps_a2;
nat_real_rate = rstar_eps_a2;
act_real_rate = r_eps_a2([1:end-1])-pie_eps_a2([2:end]);
infl          = pie_eps_a2;
output_gap    = x_eps_a2;
act_emp       = act_y-a;
nat_emp       = 0*act_emp;
