...
options_.bytecode=0;
options_.use_dll=0;
erase_compiled_function('rbcestim_static');
erase_compiled_function('rbcestim_dynamic');
...
options_.datafile = 'artificial_sample';
options_.mode_file = 'rbcestim_mode';
options_.nobs = 200;
options_.order = 1;
var_list_=[];
dynare_estimation(var_list_);
...
steady;
oo_.dr.eigval = check(M_,options_,oo_);
save('rbcestim_results.mat', 'oo_', 'M_', 'options_');
