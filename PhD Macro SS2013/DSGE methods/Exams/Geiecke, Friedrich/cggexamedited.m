...
options_ = [];
M_.fname = 'cggexamedited';
%
% Some global variables initialization
%
global_initialization;
diary off;
logname_ = 'cggexamedited.log';
if exist(logname_, 'file')
    delete(logname_)
end
diary(logname_)
M_.exo_names = 'eps0_a';
M_.exo_names_tex = 'eps0\_a';
...
options_.bytecode=0;
options_.use_dll=0;
erase_compiled_function('cggexamedited_static');
erase_compiled_function('cggexamedited_dynamic');
...
plots;
save('cggexamedited_results.mat', 'oo_', 'M_', 'options_');
