...
nat_y         = a;
act_y         = a + x_signal_a;
nat_nom_rate  = rstar_signal_a;
act_nom_rate  = r_signal_a;
nat_real_rate = rstar_signal_a;
act_real_rate = r_signal_a([1:end-1])-pie_signal_a([2:end]);
infl          = pie_signal_a;
output_gap    = x_signal_a;
act_emp       = act_y-a;
nat_emp       = 0*act_emp;
t = 1:length(a);
figure(1)
subplot(331),plot(t,infl,'k'),title('Inflation'),axis tight
subplot(332),plot(t,output_gap,'k'),title('Output Gap'),axis tight
