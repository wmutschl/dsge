...
M_.exo_names = char(M_.exo_names, 'signal_a');
M_.exo_names_tex = char(M_.exo_names_tex, 'signal\_a');
M_.endo_names = 'pie';
...
M_.endo_names = char(M_.endo_names, 'lagsignal');
M_.endo_names_tex = char(M_.endo_names_tex, 'lagsignal');
M_.param_names = 'phi';
...
options_.bytecode=0;
options_.use_dll=0;
erase_compiled_function('cggexam_static');
erase_compiled_function('cggexam_dynamic');
...
plots_3;	
save('cggexam_results.mat', 'oo_', 'M_', 'options_');
