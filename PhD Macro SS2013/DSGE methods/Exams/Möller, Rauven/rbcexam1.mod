...
% Define Priors and observable variables
	...
	varobs y; %number of observables should match number of shocks

	estimation(datafile=artificial_sample,first_obs=8001,nobs=200,mh_replic=0, mode_check);
	estimation(datafile=artificial_sample,first_obs=8001,nobs=200,mh_replic=5000,mh_nblocks=3,mode_compute=0,mode_file=rbcexam1_mode,mh_jscale=1.6);
	estimation(datafile=artificial_sample,first_obs=8001,nobs=200,mh_replic=1000,mh_nblocks=3,mode_compute=0,mode_file=rbcexam1_mode,load_mh_file,mh_jscale=1.5);
	steady; check;