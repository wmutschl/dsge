...
options_.bytecode=0;
options_.use_dll=0;
erase_compiled_function('rbcexam1_static');
erase_compiled_function('rbcexam1_dynamic');
...
options_.datafile = 'artificial_sample';
options_.mode_file = 'rbcexam1_mode';
options_.nobs = 200;
options_.order = 1;
var_list_=[];
dynare_estimation(var_list_);
...
save('rbcexam1_results.mat', 'oo_', 'M_', 'options_');
