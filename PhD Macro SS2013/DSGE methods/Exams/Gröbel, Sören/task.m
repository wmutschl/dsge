...
options_.bytecode=0;
options_.use_dll=0;
erase_compiled_function('task_static');
erase_compiled_function('task_dynamic');
...
estim_params_.param_vals = [estim_params_.param_vals; 2, NaN, (-Inf), Inf, 2, mode_and_variance_to_mean(2,0.25,1,1), .5, 1, NaN, NaN ];
...
steady;
oo_.dr.eigval = check(M_,options_,oo_);
save('task_results.mat', 'oo_', 'M_', 'options_');
