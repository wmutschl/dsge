...
options_ = [];
M_.fname = 'rbcexam_sol';
%
% Some global variables initialization
%
global_initialization;
diary off;
logname_ = 'rbcexam_sol.log';
...
options_.bytecode=0;
options_.use_dll=0;
erase_compiled_function('rbcexam_sol_static');
erase_compiled_function('rbcexam_sol_dynamic');
...
options_.datafile = 'artificial_sample';
options_.mode_file = 'rbcexam_sol_mode';
options_.nobs = 200;
options_.order = 1;
var_list_=[];
dynare_estimation(var_list_);
...
save('rbcexam_sol_results.mat', 'oo_', 'M_', 'options_');
